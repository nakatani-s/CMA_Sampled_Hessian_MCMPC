...
#define NUM_OF_ELITES  15// [4+3ln(20)]/2程度を確保　（←CMA−ESの類推より）
#define THREAD_PER_BLOCKS 10


const int sizeOfParaboloidElements = 3741; //1326, HORIZON 30 -> 496 + 254 HORIZON 35 -> 666 + 134  HORIZON 40 -> 861  HORIZON 45 -> 1081  HORIZON 50 -> 1326
const int addTermForLSM = 1259; //sizeOfParaboloidElements + addTermForLSM = THREAD_PER_BLOCKSの定数倍になるように加算する項  4000 - sizeOfParaboloidElements くらい
const float neighborVar = 0.85f;
...
#define EVALUATE_FITTING_ACCURACY
#endif
// const int 
